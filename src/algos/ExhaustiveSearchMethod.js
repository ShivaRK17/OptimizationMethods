    ...
    <form action="" onSubmit={handleSubmit}>
      ...
      <div className="container">
        ...
        <div className="input-group mb-3">
          ...
          <input type="number" min={a} required className="form-control" placeholder="" value={b} onChange={(e) => { setb(e.target.value) }} aria-describedby="bvalue" />
        </div>
        <div className="input-group mb-3">
          <span className="input-group-text" id="nvalue">Enter n:</span>
          <input type="number" min={1} required className="form-control" placeholder="" value={n} onChange={(e) => { setn(e.target.value) }} aria-describedby="nvalue" />
        </div>
      </div>
      <button className='btn btn-success' disabled={result !== ''} type="submit">Evaluate Minima</button>
    </form>
    <br />
    <div className="container">
      <h3>Iterations</h3>
